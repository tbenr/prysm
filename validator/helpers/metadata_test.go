...
func (db *ValidatorDBMock) ProposerSettings(context.Context) (*validatorServiceConfig.ProposerSettings, error) {
	panic("not implemented")
}
func (db *ValidatorDBMock) ProposerSettingsExists(ctx context.Context) (bool, error) {
	panic("not implemented")
}
func (db *ValidatorDBMock) UpdateProposerSettingsDefault(context.Context, *validatorServiceConfig.ProposerOption) error {
	panic("not implemented")
}
func (db *ValidatorDBMock) UpdateProposerSettingsForPubkey(context.Context, [fieldparams.BLSPubkeyLength]byte, *validatorServiceConfig.ProposerOption) error {
	panic("not implemented")
}
func (db *ValidatorDBMock) SaveProposerSettings(ctx context.Context, settings *validatorServiceConfig.ProposerSettings) error {
	panic("not implemented")
}
